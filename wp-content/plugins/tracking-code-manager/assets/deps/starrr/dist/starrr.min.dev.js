...
!function (a, b) {
  ...
  return b.Starrr = c = function () {
    ...
    return b.prototype.defaults = {
      ...
      for (c = [], a = 1, b = this.options.numStars; b >= 1 ? b >= a : a >= b; b >= 1 ? a++ : a--) {
      ...
      var b, c, d, e, f;
      if (a || (a = this.options.rating), a) for (b = c = 0, e = a - 1; e >= 0 ? e >= c : c >= e; b = e >= 0 ? ++c : --c) {
    ...
    starrr: function starrr() {
      ...
      return d = arguments[0], b = 2 <= arguments.length ? __slice.call(arguments, 1) : [], this.each(function () {
        var e;
        return e = a(this).data("starrr"), e || a(this).data("starrr", e = new c(a(this), d)), "string" == typeof d ? e[d].apply(e, b) : void 0;
      });
    }
  });
