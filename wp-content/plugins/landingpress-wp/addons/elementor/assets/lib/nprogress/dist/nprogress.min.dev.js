...
!function (root, factory) {
  "function" == typeof define && define.amd ? define(factory) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = factory() : root.NProgress = factory();
}(void 0, function () {
  ...
  NProgress.configure = function (options) {
    ...
    for (key in options) {
      value = options[key], void 0 !== value && options.hasOwnProperty(key) && (Settings[key] = value);
    }
  ...
  var queue = function () {
    ...
    return function (element, properties) {
      var prop,
          value,
          args = arguments;
      if (2 == args.length) for (prop in properties) {
        value = properties[prop], void 0 !== value && properties.hasOwnProperty(prop) && applyCss(element, prop, value);
