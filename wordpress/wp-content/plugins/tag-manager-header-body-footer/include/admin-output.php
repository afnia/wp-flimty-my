...
if( isset($_POST['yydev_tagmanager_nonce']) ) {
    ...
    if( wp_verify_nonce($_POST['yydev_tagmanager_nonce'], 'yydev_tagmanager_action') ) {
        ...
        $custom_lazy_load_js = yydev_tagmanager_mysql_prep( $_POST['custom_lazy_load_js'] );
...
?>
            ...
            <div class="tag-manager-line">
                ...
                <br /><br />
                <textarea class="custom_lazy_load_js" name="custom_lazy_load_js" placeholder=""><?php echo yydev_tagmanager_html_output($plugin_data_array['custom_lazy_load_js']); ?></textarea>
                <br />
