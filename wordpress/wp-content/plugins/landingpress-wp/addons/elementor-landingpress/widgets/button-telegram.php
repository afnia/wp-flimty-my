...
class LP_Button_Telegram extends Widget_Base {

	public function get_name() {
		return 'button_telegram';
	}

	public function get_title() {
		return __( 'LP - Button Telegram', 'landingpress-wp' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Join Telegram Group / Channel', 'landingpress-wp' ),
				'placeholder' => __( 'Join Telegram Group / Channel', 'landingpress-wp' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'telegram',
			[
				'label' => __( 'Telegram Link', 'landingpress-wp' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => 'https://telegram.me/xxx',
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'icon_show',
			[
				'label' => __( 'Show Telegram Icon', 'landingpress-wp' ),
				'type' => Controls_Manager::SWITCHER,
	...
	protected function render() {
		...
		if ( ! empty( $settings['telegram'] ) ) {
			$link = esc_url( trim( $settings['telegram'] ) );
				...
				<span <?php echo $this->get_render_attribute_string( 'content-wrapper' ); ?>>
					<?php if ( $settings['icon_show'] ) : ?>
						<span <?php echo $this->get_render_attribute_string( 'icon-align' ); ?>>
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/telegram.svg" alt="" height="15px" width="15px" />
						</span>
					<?php endif; ?>
