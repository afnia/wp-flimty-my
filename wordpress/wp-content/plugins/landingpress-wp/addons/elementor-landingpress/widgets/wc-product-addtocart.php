...
class LP_WC_Product_AddToCart extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$description .= '<br><br>';
		$description .= __( 'Widget ini hanya bekerja untuk <strong style="color:#9b0a46;">Simple Product</strong> saja, tidak dapat digunakan untuk Variable Product.', 'landingpress-wp' );
