...
<script type="text/template" id="tmpl-elementor-panel-categories">
	...
	<div id="elementor-panel-get-pro-elements" class="elementor-panel-nerd-box">
		...
		<a class="elementor-button elementor-button-default elementor-panel-nerd-box-link" target="_blank" href="<?php echo Utils::get_pro_link( admin_url( 'admin.php?page=go_elementor_pro&utm_source=panel-widgets&utm_campaign=gopro&utm_medium=wp-dash' ) ); ?>"><?php _e( 'Go Pro', 'elementor' ); ?></a>
	</div>
</script>
...
<script type="text/template" id="tmpl-elementor-panel-global">
	<div class="elementor-panel-nerd-box">
        ...
        <a class="elementor-button elementor-button-default elementor-panel-nerd-box-link" target="_blank" href="<?php echo Utils::get_pro_link( admin_url( 'admin.php?page=go_elementor_pro&utm_source=panel-global&utm_campaign=gopro&utm_medium=wp-dash' ) ); ?>"><?php _e( 'Go Pro', 'elementor' ); ?></a>
    </div>
</script>
