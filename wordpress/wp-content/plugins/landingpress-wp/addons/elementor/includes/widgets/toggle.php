	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-toggle .elementor-tab-title, {{WRAPPER}} .elementor-toggle .elementor-tab-title a' => 'color: {{VALUE}};',
				],
				'scheme' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-toggle .elementor-tab-title.elementor-active, {{WRAPPER}} .elementor-toggle .elementor-tab-title.elementor-active a' => 'color: {{VALUE}};',
				],
				'scheme' => [
					'type' => Scheme_Color::get_type(),
