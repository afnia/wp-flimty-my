...
!function e(t, n, i) {
  ...
  6: [function (e, t, n) {
    ...
    t.exports = i.extend({
      ...
      deactivateActiveTab: function deactivateActiveTab(e) {
      ...
      isActiveTab: function isActiveTab(e) {
      ...
      onEditSettingsChange: function onEditSettingsChange(e) {
        "activeItemIndex" === e && this.activateDefaultTab();
      },
      changeActiveTab: function changeActiveTab(e) {
  ...
  8: [function (e, t, n) {
    var i,
        o = e("elementor-frontend/handler-module");
    i = o.extend({
      getElementName: function getElementName() {
        return "global";
      },
  ...
  11: [function (e, t, n) {
    var i = e("elementor-frontend/handler-module"),
      ...
      prepareYTVideo: function prepareYTVideo(e, t) {
        var n = this,
      ...
      stretchSection: function stretchSection() {
      ...
      onGeneralSettingsChange: function onGeneralSettingsChange(e) {
      ...
      setNegative: function setNegative(e) {
  ...
  20: [function (e, t, n) {
    ...
    t.exports = i.extend({
      ...
      onYoutubeApiReady: function onYoutubeApiReady(e) {
        var t = this;
  ...
  21: [function (e, t, n) {
    ...
    t.exports = function () {
      ...
      function i(e, t, i, o) {
        var r, s, a;
        if (n[e][t]) if (i) {
          if (r = n[e][t], o) for (a = r.length; a--;) {
            (s = r[a]).callback === i && s.context === o && r.splice(a, 1);
          } else for (a = r.length; a--;) {
            r[a].callback === i && r.splice(a, 1);
          }
        } else n[e][t] = [];
      }
