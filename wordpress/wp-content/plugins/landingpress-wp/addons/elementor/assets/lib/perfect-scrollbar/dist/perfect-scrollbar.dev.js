...
(function e(t, n, r) {
  ...
  17: [function (require, module, exports) {
    ...
    var updateGeometry = require('./update-geometry'); // Handlers
  ...
  18: [function (require, module, exports) {
    ...
    function Instance(element) {
      ...
      i.railBorderXWidth = _.toInt(dom.css(i.scrollbarXRail, 'borderLeftWidth')) + _.toInt(dom.css(i.scrollbarXRail, 'borderRightWidth')); // Set rail to display:block to calculate margins
  ...
  21: [function (require, module, exports) {
    ...
    module.exports = function (element) {
      ...
      dom.css(i.scrollbarYRail, 'display', 'block');
      i.railXMarginWidth = _.toInt(dom.css(i.scrollbarXRail, 'marginLeft')) + _.toInt(dom.css(i.scrollbarXRail, 'marginRight'));
      i.railYMarginHeight = _.toInt(dom.css(i.scrollbarYRail, 'marginTop')) + _.toInt(dom.css(i.scrollbarYRail, 'marginBottom')); // Hide scrollbars not to affect scrollWidth and scrollHeight
