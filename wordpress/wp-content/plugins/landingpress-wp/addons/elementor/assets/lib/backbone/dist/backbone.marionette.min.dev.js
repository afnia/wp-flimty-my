...
!function (a, b) {
  ...
  !function (a, b) {
    ...
    return a.ChildViewContainer = function (a, b) {
      ...
      b.extend(c.prototype, {
        ...
        findByModel: function findByModel(a) {
          return this.findByModelCid(a.cid);
        },
        findByModelCid: function findByModelCid(a) {
          var b = this._indexByModel[a];
          return this.findByCid(b);
        },
        findByCustom: function findByCustom(a) {
          var b = this._indexByCustom[a];
          return this.findByCid(b);
        },
        findByIndex: function findByIndex(a) {
          return b.values(this._views)[a];
        },
        findByCid: function findByCid(a) {
        ...
        call: function call(a) {
          this.apply(a, b.tail(arguments));
        },
        apply: function apply(a, c) {
    ...
    }(a, b), a.ChildViewContainer.VERSION = "0.1.11", a.ChildViewContainer.noConflict = function () {
      return a.ChildViewContainer = c, this;
    }, a.ChildViewContainer;
  }(b, c), function (a, b) {
    var c = a.Wreqr,
        d = a.Wreqr = {};
    return a.Wreqr.VERSION = "1.3.6", a.Wreqr.noConflict = function () {
  ...
  var d = a.Marionette,
      e = a.Mn,
      f = b.Marionette = {};
  f.VERSION = "2.4.5", f.noConflict = function () {
  ...
  g._console = "undefined" != typeof console ? console : {}, g._warn = function () {
  ...
  return f.Error = f.extend.call(Error, {
    ...
    destroy: function destroy(a) {
      return a = a || {}, this.triggerMethod("before:destroy", a), this.triggerMethod("destroy", a), this.stopListening(), this;
    },
    triggerMethod: f.triggerMethod,
    mergeOptions: f.mergeOptions,
    getOption: f.proxyGetOption,
    ...
    show: function show(a, b) {
      if (this._ensureElement()) {
        ...
        if (i && this.triggerMethod("before:swapOut", this.currentView, this, b), this.currentView && e && delete this.currentView._parent, j ? this.empty() : i && k && this.currentView.off("destroy", this.empty, this), k) {
          a.once("destroy", this.empty, this), a._parent = this, this._renderView(a), i && this.triggerMethod("before:swap", a, this, b), this.triggerMethod("before:show", a, this, b), f.triggerMethodOn(a, "before:show", a, this, b), i && this.triggerMethod("swapOut", this.currentView, this, b);
    ...
    triggerAttach: !0,
    _triggerAttach: function _triggerAttach(a, b) {
      var d = (b || "") + "attach";
      c.each(a, function (a) {
        f.triggerMethodOn(a, d, a, this);
      }, this);
    },
    _displayedViews: function _displayedViews(a) {
      return c.union([a], c.result(a, "_getNestedViews") || []);
    },
    _renderView: function _renderView(a) {
    ...
    _ensureViewIsIntact: function _ensureViewIsIntact(a) {
    ...
    attachHtml: function attachHtml(a) {
    ...
    empty: function empty(a) {
      var b = this.currentView,
          c = a || {},
          d = !!c.preventDestroy;
      return b ? (b.off("destroy", this.empty, this), this.triggerMethod("before:empty", b), d || this._destroyView(), this.triggerMethod("empty", b), delete this.currentView, d && this.$el.contents().detach(), this) : this;
    },
    ...
    attachView: function attachView(a) {
    ...
    buildRegion: function buildRegion(a, b) {
    ...
    _buildRegionFromSelector: function _buildRegionFromSelector(a, b) {
      return new b({
        el: a
      });
    },
    _buildRegionFromObject: function _buildRegionFromObject(a, b) {
      var d = a.regionClass || b,
          e = c.omit(a, "selector", "regionClass");
      return a.selector && !e.el && (e.el = a.selector), new d(e);
    },
    _buildRegionFromRegionClass: function _buildRegionFromRegionClass(a) {
      return new a();
    }
    ...
    addRegions: function addRegions(a, b) {
    ...
    addRegion: function addRegion(a, b) {
      var c;
    ...
    removeRegion: function removeRegion(a) {
    ...
    _store: function _store(a, b) {
      this._regions[a] || this.length++, this._regions[a] = b;
    },
    _remove: function _remove(a, b) {
    ...
    clear: function clear() {
      var a,
          b = c.toArray(arguments),
          d = b.length;
      if (d > 0) for (a = 0; d > a; a++) {
    ...
    loadTemplate: function loadTemplate(a, c) {
      var d = b.$(a);
    ...
    delegateEvents: function delegateEvents(a) {
    ...
    _delegateDOMEvents: function _delegateDOMEvents(a) {
    ...
    _buildViewTrigger: function _buildViewTrigger(a) {
      var b = c.defaults({}, a, {
        preventDefault: !0,
        stopPropagation: !0
      }),
    ...
    _triggerEventOnBehaviors: function _triggerEventOnBehaviors(a) {
      for (var b = f._triggerMethod, c = this._behaviors, d = 0, e = c && c.length; e > d; d++) {
        b(c[d], a);
      }
    },
    _triggerEventOnParentLayout: function _triggerEventOnParentLayout(a, b) {
    ...
    _parentLayoutView: function _parentLayoutView() {
      for (var a = this._parent; a;) {
        if (a instanceof f.LayoutView) return a;
        a = a._parent;
      }
    },
    ...
    serializeCollection: function serializeCollection(a) {
      return a.toJSON.apply(a, c.rest(arguments));
    },
    ...
    attachElContent: function attachElContent(a) {
    ...
    endBuffering: function endBuffering() {
      var a,
          b = this._isShown && f.isNodeAttached(this.el);
    ...
    _triggerMethodMany: function _triggerMethodMany(a, b, d) {
    ...
    _onCollectionAdd: function _onCollectionAdd(a, b, d) {
    ...
    _onCollectionRemove: function _onCollectionRemove(a) {
    ...
    reorder: function reorder() {
      ...
      if (d) this.render();else {
        ...
        this.triggerMethod("before:reorder"), this._appendReorderedChildren(e), c.each(f, this.removeChildView, this), this.checkEmpty(), this.triggerMethod("reorder");
      }
    },
    ...
    _emptyViewIndex: -1,
    _appendReorderedChildren: function _appendReorderedChildren(a) {
      this.$el.append(a);
    },
    ...
    _filteredSortedModels: function _filteredSortedModels(a) {
    ...
    _sortModelsBy: function _sortModelsBy(a, b) {
    ...
    addEmptyView: function addEmptyView(a, b) {
      var d,
          e = this._isShown && !this.isBuffering && f.isNodeAttached(this.el),
    ...
    getChildView: function getChildView(a) {
    ...
    addChild: function addChild(a, b, c) {
    ...
    _updateIndices: function _updateIndices(a, b, c) {
      this.getOption("sort") && (b && (a._index = c), this.children.each(function (c) {
        c._index >= a._index && (c._index += b ? 1 : -1);
      }));
    },
    _addChildView: function _addChildView(a, b) {
      var c,
          d = this._isShown && !this.isBuffering && f.isNodeAttached(this.el);
    ...
    renderChildView: function renderChildView(a, b) {
    ...
    buildChildView: function buildChildView(a, b, d) {
      var e = c.extend({
        model: a
      }, d),
          g = new b(e);
    ...
    removeChildView: function removeChildView(a) {
    ...
    attachBuffer: function attachBuffer(a, b) {
      a.$el.append(b);
    },
    ...
    attachHtml: function attachHtml(a, b, c) {
      a.isBuffering ? a._bufferedChildren.splice(c, 0, b) : a._insertBefore(b, c) || a._insertAfter(b);
    },
    _insertBefore: function _insertBefore(a, b) {
      var c,
          d = this.getOption("sort") && b < this.children.length - 1;
      return d && (c = this.children.find(function (a) {
        return a._index === b + 1;
      })), c ? (c.$el.before(a.el), !0) : !1;
    },
    _insertAfter: function _insertAfter(a) {
      this.$el.append(a.el);
    },
    ...
    destroyChildren: function destroyChildren(a) {
      var b = a || {},
          d = !0,
    ...
    _shouldAddChild: function _shouldAddChild(a, b) {
      var d = this.getOption("filter");
      return !c.isFunction(d) || d.call(this, a, b, this.collection);
    },
    proxyChildEvents: function proxyChildEvents(a) {
    ...
    _getViewAndNested: function _getViewAndNested(a) {
    ...
    getChildViewContainer: function getChildViewContainer(a, b) {
      if (a.$childViewContainer) return a.$childViewContainer;
      var c,
          d = f.getOption(a, "childViewContainer");
    ...
    showChildView: function showChildView(a, b, d) {
    ...
    addRegions: function addRegions(a) {
    ...
    getRegion: function getRegion(a) {
      return this.regionManager.get(a);
    },
    getRegions: function getRegions() {
      return this.regionManager.getRegions();
    },
    _buildRegions: function _buildRegions(a) {
      var b = {
    ...
    _initializeRegions: function _initializeRegions(a) {
      var b;
    ...
    proxyViewProperties: function proxyViewProperties(a) {
    ...
    var f = /^(\S+)\s*(.*)$/,
        g = {
      behaviorTriggers: function behaviorTriggers(a, b) {
        var c = new d(this, b);
        return c.buildBehaviorTriggers();
      },
      behaviorEvents: function behaviorEvents(c, d) {
        var g = {};
    ...
    return b.extend(c, {
      ...
      getBehaviorClass: function getBehaviorClass(b, d) {
        return b.behaviorClass ? b.behaviorClass : a._getValue(c.behaviorsLookup, this, [b, d])[d];
      },
      parseBehaviors: function parseBehaviors(a, d) {
      ...
      _buildTriggerHandlersForBehavior: function _buildTriggerHandlersForBehavior(c, d) {
        var f = b.clone(b.result(c, "triggers")) || {};
        f = a.normalizeUIKeys(f, e(c)), b.each(f, b.bind(this._setHandlerForBehavior, this, c, d));
      },
      _setHandlerForBehavior: function _setHandlerForBehavior(a, b, c, d) {
    ...
    appRoute: function appRoute(a, b) {
      var c = this._getController();

      this._addAppRoute(c, a, b);
    },
    _processOnRoute: function _processOnRoute(a, b) {
      if (c.isFunction(this.onRoute)) {
        var d = c.invert(this.getOption("appRoutes"))[a];
        this.onRoute(a, d, b);
      }
    },
    processAppRoutes: function processAppRoutes(a, b) {
      if (b) {
    ...
    _addAppRoute: function _addAppRoute(a, b, d) {
      var e = a[d];
    ...
    addInitializer: function addInitializer(a) {
    ...
    addFinalizer: function addFinalizer(a) {
    ...
    addDefinition: function addDefinition(a, b) {
      this._runModuleDefinition(a, b);
    },
    _runModuleDefinition: function _runModuleDefinition(a, d) {
      if (a) {
    ...
    _getModule: function _getModule(a, b, d, e, f) {
      var g = c.extend({}, e),
          h = this.getClass(e),
          i = a[b];
    ...
    _addModuleDefinition: function _addModuleDefinition(a, b, c, d) {
      var e = this._getDefine(c),
          f = this._getStartWithParent(c, b);

      e && b.addDefinition(e, d), this._addStartWithParent(a, b, f);
    },
    _getStartWithParent: function _getStartWithParent(a, b) {
      var d;
    ...
    _getDefine: function _getDefine(a) {
      return !c.isFunction(a) || a.prototype instanceof f.Module ? c.isObject(a) ? a.define : null : a;
    },
    _addStartWithParent: function _addStartWithParent(a, b, c) {
