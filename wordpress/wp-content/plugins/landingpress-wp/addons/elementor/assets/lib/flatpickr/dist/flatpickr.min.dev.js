...
!function (e, t) {
        ...
        void 0 !== M._flatpickr && (M._flatpickr.destroy(), M._flatpickr = void 0), M._flatpickr = function (r, s) {
          ...
          function _(e) {
            if (void 0 !== X.daysContainer) {
              ...
              for (X.weekNumbers && X.weekNumbers.firstChild && (X.weekNumbers.textContent = ""), n && (X.minRangeDate = new Date(X.currentYear, X.currentMonth - 1, l), X.maxRangeDate = new Date(X.currentYear, X.currentMonth + 1, (42 - t) % o)); l <= i; l++, c++) {
              ...
              if (s.appendChild(r), X.config.animate && void 0 !== e) for (; X.daysContainer.childNodes.length > 1;) {
          ...
          function P(e, t, n, a) {
            ...
            if (!(i < 0 && X._hidePrevMonthArrow || i > 0 && X._hideNextMonthArrow)) {
              ...
              if (i < 0) for (; o.nextSibling && /curr/.test(o.nextSibling.className);) {
                X.monthNav.removeChild(o.nextSibling);
              } else if (i > 0) for (; o.previousSibling && /curr/.test(o.previousSibling.className);) {
          ...
          function H(e) {
            ...
            if ("Enter" === e.key && t) {
              ...
              switch (e.key) {
                ...
                case "ArrowLeft":
                case "ArrowRight":
                  if (r) X.hourElement && X.hourElement.focus();else if (e.preventDefault(), X.daysContainer) {
          ...
          function R(e) {
            if (1 === X.selectedDates.length && e.classList.contains("flatpickr-day") && void 0 !== X.minRangeDate && void 0 !== X.maxRangeDate) {
              ...
              for (var l = 0, c = X.days.childNodes[l].dateObj; l < 42; l++, c = X.days.childNodes[l] && X.days.childNodes[l].dateObj) {
                !function (r, l) {
                  var c = l.getTime(),
          ...
          function K(t) {
            ...
            if (void 0 !== n) {
              ...
              if (X.selectedDateElem = a, "single" === X.config.mode) X.selectedDates = [o];else if ("multiple" === X.config.mode) {
                var l = V(o);
          ...
          function U(e, t) {
            ...
            });else if (e instanceof Date || "number" == typeof e) n = [X.parseDate(e, t)];else if ("string" == typeof e) switch (X.config.mode) {
              case "single":
                n = [X.parseDate(e, t)];
                break;
          ...
          function $(e) {
            return e.map(function (e) {
              return "string" == typeof e || "number" == typeof e || e instanceof Date ? X.parseDate(e, void 0, !0) : e && "object" == _typeof(e) && e.from && e.to ? {
            ...
            if (0 === e || e) {
              ...
              if (e instanceof Date) a = new Date(e.getTime());else if ("string" != typeof e && void 0 !== e.toFixed) a = new Date(e);else if ("string" == typeof e) {
                var o = t || (X.config || C.defaultConfig).dateFormat,
                    r = String(e).trim();
                if ("today" === r) a = new Date(), n = !0;else if (/Z$/.test(r) || /GMT$/.test(r)) a = new Date(e);else if (X.config && X.config.parseDate) a = X.config.parseDate(e, o);else {
          ...
          return X.parseDate = q, X.formatDate = function (e, t) {
            return void 0 !== X.config && void 0 !== X.config.formatDate ? X.config.formatDate(e, t) : t.split("").map(function (t, n, a) {
              return _D[t] && "\\" !== a[n - 1] ? _D[t](e, X.l10n, X.config) : "\\" !== t ? t : "";
            }).join("");
            ...
            null !== e && "object" == _typeof(e) ? Object.assign(X.config, e) : X.config[e] = t, X.redraw(), k();
            ...
            X.element = X.input = r, X.isOpen = !1, function () {
              ...
              for (Object.defineProperty(X.config, "enable", {
                ...
                set: W("max")
              }), Object.assign(X.config, a, n), i = 0; i < e.length; i++) {
            ...
            }(), "object" != _typeof(X.config.locale) && void 0 === C.l10ns[X.config.locale] && X.config.errorHandler(new Error("flatpickr: invalid locale " + X.config.locale)), X.l10n = l({}, C.l10ns["default"], "object" == _typeof(X.config.locale) ? X.config.locale : "default" !== X.config.locale ? C.l10ns[X.config.locale] : void 0), v.K = "(" + X.l10n.amPM[0] + "|" + X.l10n.amPM[1] + "|" + X.l10n.amPM[0].toLowerCase() + "|" + X.l10n.amPM[1].toLowerCase() + ")", X.input = X.config.wrap ? r.querySelector("[data-input]") : r, X.input ? (X.input._type = X.input.type, X.input.type = "text", X.input.classList.add("flatpickr-input"), X._input = X.input, X.config.altInput && (X.altInput = a(X.input.nodeName, X.input.className + " " + X.config.altInputClass), X._input = X.altInput, X.altInput.placeholder = X.input.placeholder, X.altInput.disabled = X.input.disabled, X.altInput.required = X.input.required, X.altInput.type = "text", X.input.type = "hidden", !X.config["static"] && X.input.parentNode && X.input.parentNode.insertBefore(X.altInput, X.input.nextSibling)), X.config.allowInput || X._input.setAttribute("readonly", "readonly"), X._positionElement = X.config.positionElement || X._input) : X.config.errorHandler(new Error("Invalid input element specified")), function () {
  ...
  var l = Object.assign || function (e) {
    ...
    D: function D(e, t, n) {
      return t.weekdays.shorthand[_D.w(e, t, n)];
    },
    F: function F(e, t, n) {
      return c(_D.n(e, t, n) - 1, !1, t);
    },
    G: function G(e, t, n) {
      return f(_D.h(e, t, n));
    },
  ...
  var C;
  return C = function C(e, t) {
    return e instanceof NodeList ? r(e, t) : "string" == typeof e ? r(window.document.querySelectorAll(e), t) : r([e], t);
  }, "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && (window.flatpickr = C), C.defaultConfig = s, C.l10ns = {
    en: l({}, u),
    "default": l({}, u)
