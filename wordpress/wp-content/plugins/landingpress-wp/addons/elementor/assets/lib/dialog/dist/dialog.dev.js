...
(function ($, global) {
  ...
  var DialogsManager = {
    widgetsTypes: {},
    createWidgetType: function createWidgetType(typeName, properties, Parent) {
      if (!Parent) {
        Parent = this.Widget;
      }
    ...
    addWidgetType: function addWidgetType(typeName, properties, Parent) {
    ...
    getWidgetType: function getWidgetType(widgetType) {
  ...
  DialogsManager.Instance = function () {
    ...
    var initSettings = function initSettings(options) {
      var defaultSettings = {
        classPrefix: 'dialog',
        effects: {
          show: 'fadeIn',
  ...
  DialogsManager.Widget = function (widgetName) {
    ...
    var callEffect = function callEffect(intent, params) {
    ...
    var initSettings = function initSettings(parent, userSettings) {
    ...
    var initSettingsEvents = function initSettingsEvents() {
    ...
    var normalizeClassName = function normalizeClassName(name) {
      return name.replace(/([a-z])([A-Z])/g, function () {
        return arguments[1] + '-' + arguments[2].toLowerCase();
      });
    };

    var hideOnClick = function hideOnClick(event) {
    ...
    var hideOnOutsideClick = function hideOnOutsideClick(event) {
    ...
    var onWindowKeyUp = function onWindowKeyUp(event) {
      var ESC_KEY = 27,
          keyCode = event.which;
  ...
  DialogsManager.Widget.prototype.types = []; // Inheritable widget methods
  ...
  DialogsManager.addWidgetType('buttons', {
    activeKeyUp: function activeKeyUp(event) {
      var TAB_KEY = 9;
  ...
  DialogsManager.addWidgetType('lightbox', DialogsManager.getWidgetType('buttons').extend('lightbox', {
    ...
    setHeaderMessage: function setHeaderMessage(message) {
  ...
  DialogsManager.addWidgetType('confirm', DialogsManager.getWidgetType('lightbox').extend('confirm', {
    onReady: function onReady() {
      ...
      this.addButton({
        name: 'cancel',
        text: strings.cancel,
        callback: function callback(widget) {
...
})(typeof jQuery !== 'undefined' ? jQuery : typeof require === 'function' && require('jquery'), typeof module !== 'undefined' ? module.exports : window);