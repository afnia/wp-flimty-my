  ...
  c.Instance = function () {
    ...
    this.createWidget = function (a, d) {
      var e = c.getWidgetType(a),
          f = new e(a);
      return d = d || {}, f.init(b, d), f.setMessage(d.message), f;
    ...
    var d = this,
        ...
        i = ["refreshPosition"],
        j = function j() {
      g.window.on("keyup", s), e.hide.onOutsideClick && g.window[0].addEventListener("click", r, !0), (e.hide.onClick || e.hide.onBackgroundClick) && g.widget.on("click", q), e.position.autoRefresh && g.window.on("resize", d.refreshPosition);
    },
        k = function k(b, c) {
      var d = e.effects[b],
          f = g.widget;
      ...
      a.each(b, function () {
        ...
        m = function m() {
      d.addElement("widget"), d.addElement("message"), d.addElement("window", window), d.addElement("container", e.container);
      var b = d.getSettings("id");
      b && d.setID(b);
      var c = [];
      a.each(d.types, function () {
        c.push(e.classes.globalPrefix + "-type-" + this);
      }), c.push(d.getSettings("className")), d.getElements("widget").addClass(c.join(" "));
    },
        n = function n(c, f) {
      ...
      }, a.extend(!0, e, d.getDefaultSettings(), f), o();
    },
        o = function o() {
      a.each(e, function (a) {
      ...
      d.hide();
        ...
        r = function r(b) {
      a(b.target).closest(g.widget).length || d.hide();
    },
        s = function s(a) {
      var b = 27,
          c = a.which;
      b === c && d.hide();
        ...
        t = function t() {
      g.window.off("keyup", s), e.hide.onOutsideClick && g.window[0].removeEventListener("click", r, !0), (e.hide.onClick || e.hide.onBackgroundClick) && g.widget.off("click", q), e.position.autoRefresh && g.window.off("resize", d.refreshPosition);
    };
    ...
    this.addElement = function (b, c, d) {
      ...
      return l(), d.trigger("init", b), n(a, b), m(), d.buildWidget(), d.attachEvents && d.attachEvents(), d.trigger("ready"), d;
    }, this.getElements = function (a) {
      return a ? g[a] : g;
    }, this.hide = function () {
      return clearTimeout(h), k("hide", arguments), t(), d.trigger("hide"), d;
      ...
      return d.getElements("widget").attr("id", a), d;
    }, this.setSettings = function (b, c) {
      return "object" == _typeof(c) ? a.extend(!0, e[b], c) : e[b] = c, d;
    }, this.show = function () {
      ...
      if (e.position.enable) {
        ...
        g[b.of] && (b.of = g[b.of]), g[b.element].position(b);
      }
      ...
      return t(), g.widget.remove(), d.trigger("destroy"), d;
    };
  }, c.Widget.prototype.types = [], c.Widget.prototype.buildWidget = function () {
    var a = this.getElements();
    a.widget.html(a.message);
    ...
    addButton: function addButton(b) {
      var c = this,
          d = c.addElement(b.name, a("<" + this.getSettings("buttonTag") + ">").text(b.text), "button");
      c.buttons.push(d);

      var e = function e() {
        c.getSettings("hide").onButtonClick && c.hide(), a.isFunction(b.callback) && b.callback.call(this, c);
      };

      return d.on("click", e), b.hotKey && (this.hotKeys[b.hotKey] = e), this.getElements("buttonsWrapper").append(d), b.focus && (this.focusedButton = d), c;
    },
    ...
    buildWidget: function buildWidget() {
      ...
      var a = this.addElement("widgetHeader"),
          b = this.addElement("widgetContent"),
          d = this.getElements();

      if (b.append(a, d.message, d.buttonsWrapper), d.widget.html(b), this.getSettings("closeButton")) {
        var e = this.addElement("closeButton", '<div><i class="' + this.getSettings("closeButtonClass") + '"></i></div>');
        b.prepend(e);
      }
    },
    ...
    onReady: function onReady() {
      var a = this.getElements(),
          b = this.getSettings();
      "auto" !== b.contentWidth && a.message.width(b.contentWidth), "auto" !== b.contentHeight && a.message.height(b.contentHeight), this.setHeaderMessage(b.headerMessage);
    },
    setHeaderMessage: function setHeaderMessage(a) {
      return this.getElements("widgetHeader").html(a), this;
    }
