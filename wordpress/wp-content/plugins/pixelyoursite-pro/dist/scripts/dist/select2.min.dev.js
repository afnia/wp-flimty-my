  ...
  var b = function () {
    ...
    return function () {
      ...
      return b.Extend(d, a), d.prototype._applyDefaults = function (a) {
        ...
        function d() {
          var d = f.transport(f, function (d) {
            ...
            e.options.get("debug") && window.console && console.error && (f && f.results && Array.isArray(f.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), b(f);
          }, function () {
      ...
      function b(b, c, d) {
        ...
        if (void 0 !== g && (this.insertTag = g), b.call(this, c, d), Array.isArray(e)) for (var h = 0; h < e.length; h++) {
          var i = e[h],
      ...
      return c.Extend(e, c.Observable), e.prototype._generateId = function (a) {
        ...
        var c = b[0];
        Array.isArray(c) && (c = a.map(c, function (a) {
          return a.toString();
