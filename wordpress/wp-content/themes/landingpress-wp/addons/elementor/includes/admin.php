...
class Admin {
	...
	public function print_switch_mode_button( $post ) {
		...
		<div id="elementor-switch-mode">
			...
			<button id="elementor-switch-mode-button" class="elementor-button button button-primary button-hero" style="padding:0 25px;">
				...
				<span class="elementor-switch-mode-off">
					...
					<i class="eicon-clone" aria-hidden="true" style="margin:0 5px;"></i>
					LandingPress
				</span>
			</button>
		</div>
		<div id="elementor-editor">
			<a id="elementor-go-to-edit-page-link" href="<?php echo Utils::get_edit_link( $post->ID ); ?>">
				<div id="elementor-editor-button" class="elementor-button button button-primary button-hero" style="padding:0 25px;">
					<i class="eicon-elementor" aria-hidden="true"></i>
					<?php _e( 'Edit with Elementor', 'elementor' ); ?>
					<i class="eicon-clone" aria-hidden="true" style="margin:0 5px;"></i>
					LandingPress
	...
	public function plugin_action_links( $links ) {
		...
		$links['go_pro'] = sprintf( '<a href="%s" class="elementor-plugins-gopro">%s</a>', Utils::get_pro_link( admin_url( 'admin.php?page=go_elementor_pro&utm_source=wp-plugins&utm_campaign=gopro&utm_medium=wp-dash' ) ), __( 'Go Pro', 'elementor' ) );
	...
	private function get_dashboard_overview_widget_footer_actions() {
		...
		$additions_actions = [
			'go-pro' => [
				...
				'link' => Utils::get_pro_link( admin_url( 'admin.php?page=go_elementor_pro&utm_source=wp-overview-widget&utm_campaign=gopro&utm_medium=wp-dash' ) ),
			],
		];
