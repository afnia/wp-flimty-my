...
class LP_Button_Messenger extends Widget_Base {

	public function get_name() {
		return 'button_messenger';
	}

	public function get_title() {
		return __( 'LP - Button Facebook Messenger', 'landingpress-wp' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Chat Me on Messenger', 'landingpress-wp' ),
				'placeholder' => __( 'Chat Me on Messenger', 'landingpress-wp' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'messenger',
			[
				'label' => __( 'FB Messenger Username / FB Page ID', 'landingpress-wp' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => '',
				'label_block' => true,
		...
		$this->add_control(
			'icon_show',
			[
				'label' => __( 'Show Messenger Icon', 'landingpress-wp' ),
				'type' => Controls_Manager::SWITCHER,
	...
	protected function render() {
		...
		if ( ! empty( $settings['messenger'] ) ) {
			$link = 'http://m.me/' . trim( $settings['messenger'] );
				...
				<span <?php echo $this->get_render_attribute_string( 'content-wrapper' ); ?>>
					<?php if ( $settings['icon_show'] ) : ?>
						<span <?php echo $this->get_render_attribute_string( 'icon-align' ); ?>>
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/messenger.svg" alt="" height="15px" width="15px" />
						</span>
					<?php endif; ?>
