...
!function (t) {
  ...
  function g(t) {
    return null == t ? t + "" : "object" == _typeof(t) ? n[e.call(t)] || "object" : _typeof(t);
  }
  ...
  r.style.cssText = "background-color:rgba(1,1,1,.5)", s.rgba = -1 < r.style.backgroundColor.indexOf("rgba"), h(d, function (t, e) {
    ...
    transition: function transition(t, s) {
      var t = (f = l(t))._space(),
          e = d[t],
  ...
  function H(t) {
    var e,
        ...
        o = {};
    if (r && r.length && r[0] && r[r[0]]) for (n = r.length; n--;) {
  ...
  function W(t) {
    return !t || "number" == typeof t || u.fx.speeds[t] || "string" == typeof t && !u.effects.effect[t] || "function" == typeof t || "object" == _typeof(t) && !t.effect;
  }
  ...
  return u.effects = {
    ...
    return this.queue(function () {
      ...
      r(), e = e.map(function () {
        return this.end = H(this.el[0]), this.diff = function (t, e) {
          ...
          for (n in e) {
            r = e[n], t[n] === r || x[n] || !u.fx.step[n] && isNaN(parseFloat(r)) || (o[n] = r);
          }
    ...
    switchClass: function switchClass(t, e, n, r, o) {
    ...
    createWrapper: function createWrapper(n) {
    ...
    scaledDimensions: function scaledDimensions(t, e, n) {
      var r;
      return 0 === e ? {
        height: 0,
        width: 0,
    ...
    setTransition: function setTransition(r, t, o, i) {
