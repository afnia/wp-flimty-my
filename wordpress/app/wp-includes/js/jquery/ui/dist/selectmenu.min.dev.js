...
!function (e) {
  ...
  return u.widget("ui.selectmenu", [u.ui.formResetMixin, {
    version: "1.13.2",
    ...
    _create: function _create() {
      ...
      this.ids = {
        ...
        button: e + "-button",
        menu: e + "-menu"
      }, this._drawButton(), this._drawMenu(), this._bindFormResetHandler(), this._rendered = !1, this.menuItems = u();
    },
    _drawButton: function _drawButton() {
      ...
      }), this.element.hide(), this.button = u("<span>", {
      ...
      }).insertAfter(this.element), this._addClass(this.button, "ui-selectmenu-button ui-selectmenu-button-closed", "ui-button ui-widget"), e = u("<span>").appendTo(this.button), this._addClass(e, "ui-selectmenu-icon", "ui-icon " + this.options.icons.button), this.buttonItem = this._renderButtonItem(i).appendTo(this.button), !1 !== this.options.width && this._resizeButton(), this._on(this.button, this._buttonEvents), this.button.one("focusin", function () {
    ...
    _drawMenu: function _drawMenu() {
      ...
      this.menu = u("<ul>", {
        ...
        id: this.ids.menu
      }), this.menuWrap = u("<div>").append(this.menu), this._addClass(this.menuWrap, "ui-selectmenu-menu", "ui-front"), this.menuWrap.appendTo(this._appendTo()), this.menuInstance = this.menu.menu({
        classes: {
    ...
    _position: function _position() {
      this.menuWrap.position(u.extend({
        of: this.button
    ...
    _renderMenu: function _renderMenu(n, e) {
      var s = this,
          o = "";
    ...
    _move: function _move(e, t) {
      var i,
          n = ".ui-menu-item";
      this.isOpen ? i = this.menuItems.eq(this.focusIndex).parent("li") : (i = this.menuItems.eq(this.element[0].selectedIndex).parent("li"), n += ":not(.ui-state-disabled)"), (i = "first" === e || "last" === e ? i["first" === e ? "prevAll" : "nextAll"](n).eq(-1) : i[e + "All"](n).eq(0)).length && this.menuInstance.focus(t, i);
    },
    ...
    _documentClick: {
      mousedown: function mousedown(e) {
        !this.isOpen || u(e.target).closest(".ui-selectmenu-menu, #" + u.escapeSelector(this.ids.button)).length || this.close(e);
      }
    },
    _buttonEvents: {
    ...
    _appendTo: function _appendTo() {
      ...
      return e = (e = (e = e && (e.jquery || e.nodeType ? u(e) : this.document.find(e).eq(0))) && e[0] ? e : this.element.closest(".ui-front, dialog")).length ? e : this.document[0].body;
    },
    ...
    _resizeButton: function _resizeButton() {
      ...
      !1 === e ? this.button.css("width", "") : (null === e && (e = this.element.show().outerWidth(), this.element.hide()), this.button.outerWidth(e));
    },
    ...
    _parseOption: function _parseOption(e, t) {
