...
!function (e) {
  ...
  return V.extend(V.ui, {
    ...
    _autoSize: function _autoSize(e) {
      var t, a, i, s, r, n;
      this._get(e, "autoSize") && !e.inline && (r = new Date(2009, 11, 20), (n = this._get(e, "dateFormat")).match(/[DM]/) && (r.setMonth((t = function t(e) {
    ...
    _isDisabledDatepicker: function _isDisabledDatepicker(e) {
      if (e) for (var t = 0; t < this._disabledInputs.length; t++) {
    ...
    _hideDatepicker: function _hideDatepicker(e) {
      var t,
          a,
          i = this._curInst;
      !i || e && i !== V.data(e, "datepicker") || this._datepickerShowing && (e = this._get(i, "showAnim"), a = this._get(i, "duration"), t = function t() {
    ...
    _selectDate: function _selectDate(e, t) {
      ...
      t = null != t ? t : this._formatDate(e), e.input && e.input.val(t), this._updateAlternate(e), (a = this._get(e, "onSelect")) ? a.apply(e.input ? e.input[0] : null, [t, e]) : e.input && e.input.trigger("change"), e.inline ? this._updateDatepicker(e) : (this._hideDatepicker(), this._lastInput = e.input[0], "object" != _typeof(e.input[0]) && e.input.trigger("focus"), this._lastInput = null);
    },
    ...
    parseDate: function parseDate(t, s, e) {
      ...
      for (var a, i, r = 0, n = (e ? e.shortYearCutoff : null) || this._defaults.shortYearCutoff, n = "string" != typeof n ? n : new Date().getFullYear() % 100 + parseInt(n, 10), d = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort, c = (e ? e.dayNames : null) || this._defaults.dayNames, o = (e ? e.monthNamesShort : null) || this._defaults.monthNamesShort, l = (e ? e.monthNames : null) || this._defaults.monthNames, h = -1, u = -1, p = -1, g = -1, _ = !1, f = function f(e) {
        ...
        if (_) "'" !== t.charAt(y) || f("'") ? m() : _ = !1;else switch (t.charAt(y)) {
          case "d":
            p = k("d");
            break;
      ...
      if (-1 === h ? h = new Date().getFullYear() : h < 100 && (h += new Date().getFullYear() - new Date().getFullYear() % 100 + (h <= n ? 0 : -100)), -1 < g) for (u = 1, p = g;;) {
    ...
    formatDate: function formatDate(t, e, a) {
      ...
      if (e) for (r = 0; r < t.length; r++) {
        if (u) "'" !== t.charAt(r) || l("'") ? h += t.charAt(r) : u = !1;else switch (t.charAt(r)) {
          case "d":
            h += i("d", e.getDate(), 2);
            break;
    ...
    _possibleChars: function _possibleChars(t) {
      for (var e = "", a = !1, i = function i(e) {
        ...
        if (a) "'" !== t.charAt(s) || i("'") ? e += t.charAt(s) : a = !1;else switch (t.charAt(s)) {
          case "d":
          case "m":
          case "y":
          case "@":
    ...
    _generateHTML: function _generateHTML(e) {
      ...
      if (K < 0 && (K += 12, j--), A) for (t = this._daylightSavingAdjust(new Date(A.getFullYear(), A.getMonth() - Y[0] * Y[1] + 1, A.getDate())), t = T && t < T ? T : t; this._daylightSavingAdjust(new Date(j, K, 1)) > t;) {
        --K < 0 && (K = 11, j--);
      }
        ...
        for (u = "", this.maxRows = 4, p = 0; p < Y[1]; p++) {
          ...
          for (f += k + "</tr></thead><tbody>", m = this._getDaysInMonth(j, K), j === e.selectedYear && K === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, m)), D = (this._getFirstDayOfMonth(j, K) - s + 7) % 7, m = Math.ceil((D + m) / 7), U = J && this.maxRows > m ? this.maxRows : m, this.maxRows = U, y = this._daylightSavingAdjust(new Date(j, K, 1 - D)), P = 0; P < U; P++) {
            for (f += "<tr>", z = r ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(y) + "</td>" : "", l = 0; l < 7; l++) {
              v = n ? n.apply(e.input ? e.input[0] : null, [y]) : [!0, ""], b = (M = y.getMonth() !== K) && !W || !v[0] || T && y < T || A && A < y, z += "<td class='" + (5 <= (l + s + 6) % 7 ? " ui-datepicker-week-end" : "") + (M ? " ui-datepicker-other-month" : "") + (y.getTime() === g.getTime() && K === e.selectedMonth && e._keyEvent || c.getTime() === y.getTime() && c.getTime() === g.getTime() ? " " + this._dayOverClass : "") + (b ? " " + this._unselectableClass + " ui-state-disabled" : "") + (M && !d ? "" : " " + v[1] + (y.getTime() === N.getTime() ? " " + this._currentClass : "") + (y.getTime() === B.getTime() ? " ui-datepicker-today" : "")) + "'" + (M && !d || !v[2] ? "" : " title='" + v[2].replace(/'/g, "&#39;") + "'") + (b ? "" : " data-handler='selectDay' data-event='click' data-month='" + y.getMonth() + "' data-year='" + y.getFullYear() + "'") + ">" + (M && !d ? "&#xa0;" : b ? "<span class='ui-state-default'>" + y.getDate() + "</span>" : "<a class='ui-state-default" + (y.getTime() === B.getTime() ? " ui-state-highlight" : "") + (y.getTime() === N.getTime() ? " ui-state-active" : "") + (M ? " ui-priority-secondary" : "") + "' href='#' aria-current='" + (y.getTime() === N.getTime() ? "true" : "false") + "' data-date='" + y.getDate() + "'>" + y.getDate() + "</a>") + "</td>", y.setDate(y.getDate() + 1), y = this._daylightSavingAdjust(y);
            }
    ...
    _formatDate: function _formatDate(e, t, a, i) {
      ...
      i = t ? "object" == _typeof(t) ? t : this._daylightSavingAdjust(new Date(i, a, t)) : this._daylightSavingAdjust(new Date(e.currentYear, e.currentMonth, e.currentDay));
