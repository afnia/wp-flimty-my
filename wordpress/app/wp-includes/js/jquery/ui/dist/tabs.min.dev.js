  ...
  return l.widget("ui.tabs", {
    ...
    _setOptionDisabled: function _setOptionDisabled(t) {
      ...
      for (Array.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1), i = 0; e = this.tabs[i]; i++) {
        e = l(e), !0 === t || -1 !== l.inArray(i, t) ? (e.attr("aria-disabled", "true"), this._addClass(e, null, "ui-state-disabled")) : (e.removeAttr("aria-disabled"), this._removeClass(e, null, "ui-state-disabled"));
      }
    ...
    _ajaxSettings: function _ajaxSettings(t, i, a) {
      var s = this;
      return {
