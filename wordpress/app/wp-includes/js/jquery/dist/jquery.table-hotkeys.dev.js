...
(function ($) {
  ...
  $.table_hotkeys = function (table, keys, opts) {
    ...
    set_current_row = function set_current_row(tr) {
    ...
    adjacent_row_callback = function adjacent_row_callback(which) {
      if (!adjacent_row(which) && typeof opts[which + '_page_link_cb'] === 'function') {
        opts[which + '_page_link_cb']();
      }
    };

    get_adjacent_row = function get_adjacent_row(which) {
    ...
    adjacent_row = function adjacent_row(which) {
    ...
    prev_row = function prev_row() {
      return adjacent_row('prev');
    };

    next_row = function next_row() {
    ...
    if (opts.highlight_first) set_current_row(first_row);else if (opts.highlight_last) set_current_row(get_last_row());
