...
!function (a) {
  "function" == typeof define && define.amd ? define(["jquery"], a) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = function (e, t) {
  ...
  O.fn.attr2 = function () {
          ...
          C("fileAPI :" + a), !1 !== F.iframe && (F.iframe || (e || l) && !a) ? F.closeKeepAlive ? O.get(F.closeKeepAlive, function () {
            ...
            if (F.extraData) {
              var r = function (e) {
                ...
                for (t = 0; t < n; t++) {
                  r[t] = r[t].replace(/\+/g, " "), a = r[t].split("="), o.push([decodeURIComponent(a[0]), decodeURIComponent(a[1])]);
                }
    ...
    function f(e) {
      ...
      if (g.abort = function (e) {
        m.abort(e);
      }, e) for (a = 0; a < M.length; a++) {
        t = O(M[a]), X ? t.prop("disabled", !1) : t.removeAttr("disabled");
      }
      ...
      function n() {
        ...
        try {
          if (l.extraData) for (var n in l.extraData) {
            l.extraData.hasOwnProperty(n) && (O.isPlainObject(l.extraData[n]) && l.extraData[n].hasOwnProperty("name") && l.extraData[n].hasOwnProperty("value") ? r.push(O('<input type="hidden" name="' + l.extraData[n].name + '">', c).val(l.extraData[n].value).appendTo(o)[0]) : r.push(O('<input type="hidden" name="' + n + '">', c).val(l.extraData[n]).appendTo(o)[0]));
          }
    ...
    if (0 !== this.length) {
      ...
      if ((i = o && (e || /(Edge|Trident)\//.test(navigator.userAgent)) && (o = O(':input[form="' + o + '"]').get()).length ? (i || []).concat(o) : i) && i.length) {
        for (var s, c, l, u, f, d = 0, m = (i = O.isFunction(a) ? O.map(i, a) : i).length; d < m; d++) {
          if ((f = (l = i[d]).name) && !l.disabled) if (e && n.clk && "image" === l.type) n.clk === l && (r.push({
            name: f,
            value: O(l).val(),
            type: l.type
          }), r.push({
            ...
            name: f + ".y",
            value: n.clk_y
          }));else if ((c = O.fieldValue(l, !0)) && c.constructor === Array) for (t && t.push(l), s = 0, u = c.length; s < u; s++) {
            r.push({
              name: f,
              value: c[s]
            });
            ...
            t && t.push(l);
            var p = l.files;
            if (p.length) for (s = 0; s < p.length; s++) {
              r.push({
                name: f,
                value: p[s],
                type: l.type
    ...
    return this.each(function () {
      ...
      if (e) {
        ...
        if (t && t.constructor === Array) for (var a = 0, r = t.length; a < r; a++) {
          o.push({
            name: e,
            value: t[a]
          });
