...
(function (factory) {
  ...
  jQuery.migrateVersion = "3.4.1"; // Returns 0 if v1 == v2, -1 if v1 < v2, 1 if v1 > v2
  ...
  (function () {
    ...
    if (!jQuery || !jQueryVersionSince("3.0.0") || jQueryVersionSince("5.0.0")) {
  ...
  migratePatchFunc(jQuery.fn, "css", function (name, value) {
    ...
    if (typeof value === "number") {
      camelName = camelCase(name); // Use `internalCssNumber` to avoid triggering our warnings in this
      // internal check.
