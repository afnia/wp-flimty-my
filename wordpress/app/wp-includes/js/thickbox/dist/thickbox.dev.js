...
function tb_show(caption, url, imageGroup) {
  ...
  try {
    ...
    if (urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp' || urlType == '.webp') {
      //code to show images
      TB_PrevCaption = "";
      TB_PrevURL = "";
      TB_PrevHTML = "";
      ...
      imgPreloader.onload = function () {
        imgPreloader.onload = null; // Resizing large images - original by Christian Montoya edited by me.
        ...
        if (!(TB_PrevHTML === "")) {
          var _goPrev = function _goPrev() {
            if (jQuery(document).off("click", _goPrev)) {
              jQuery(document).off("click", _goPrev);
            }
          ...
          jQuery("#TB_prev").on('click', _goPrev);
        }
        ...
        if (!(TB_NextHTML === "")) {
          ...
          jQuery("#TB_next").on('click', _goNext);
        }
