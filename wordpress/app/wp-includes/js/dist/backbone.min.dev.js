...
!function (n) {
  var s = "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self.self === self && self || "object" == (typeof global === "undefined" ? "undefined" : _typeof(global)) && global.global === global && global;
  ...
  function a(t, e, i, n, s) {
    ...
    } else if (i && c.test(i)) for (r = i.split(c); o < r.length; o++) {
      e = t(e, r[o], n, s);
    } else e = t(e, i, n, s);
  ...
  var o,
      ...
      e = (h.VERSION = "1.5.0", h.$ = e, h.noConflict = function () {
    ...
    if (t) {
      var n = t._listenId || (t._listenId = b.uniqueId("l")),
          ...
          r = o = s[n],
          s = (r || (this._listenId || (this._listenId = b.uniqueId("l")), r = o = s[n] = new g(this, t)), u(t, e, i, this));
    ...
    set: function set(t, e, i) {
      if (null != t) {
        var n;
        if ("object" == _typeof(t) ? (n = t, i = e) : (n = {})[t] = e, !this._validate(n, i = i || {})) return !1;
        var s,
            r,
            o = i.unset,
            t = i.silent,
            h = [],
            a = this._changing,
            l = (this._changing = !0, a || (this._previousAttributes = b.clone(this.attributes), this.changed = {}), this.attributes),
            c = this.changed,
            u = this._previousAttributes;

        for (s in n) {
          e = n[s], b.isEqual(l[s], e) || h.push(s), b.isEqual(u[s], e) ? delete c[s] : c[s] = e, o ? delete l[s] : l[s] = e;
        }
    ...
    save: function save(t, e, i) {
      null == t || "object" == _typeof(t) ? (n = t, i = e) : (n = {})[t] = e;
      var n,
          s = (i = b.extend({
        validate: !0,
        parse: !0
    ...
    url: function url() {
      var t,
          e = b.result(this, "urlRoot") || b.result(this.collection, "url") || R();
    ...
    set: function set(t, e) {
      if (null != t) {
        ...
        for (var i = !b.isArray(t), n = (t = i ? [t] : t.slice(), e.at), s = ((n = (n = null != n ? +n : n) > this.length ? this.length : n) < 0 && (n += this.length + 1), []), r = [], o = [], h = [], a = {}, l = e.add, c = e.merge, u = e.remove, d = !1, f = this.comparator && null == n && !1 !== e.sort, p = b.isString(this.comparator) ? this.comparator : null, g = 0; g < t.length; g++) {
          var v,
              m = t[g],
              _ = this.get(m);

          _ ? (c && m !== _ && (v = this._isModel(m) ? m.attributes : m, e.parse && (v = _.parse(v, e)), _.set(v, e), o.push(_), f) && !d && (d = _.hasChanged(p)), a[_.cid] || (a[_.cid] = !0, s.push(_)), t[g] = _) : l && (m = t[g] = this._prepareModel(m, e)) && (r.push(m), this._addReference(m, e), a[m.cid] = !0, s.push(m));
        }
        ...
        if (s.length && !f && l && u ? (y = this.length !== s.length || b.some(this.models, function (t, e) {
          ...
          for (g = 0; g < r.length; g++) {
            null != n && (e.index = n + g), (m = r[g]).trigger("add", m, this, e);
          }
    ...
    create: function create(t, e) {
      ...
      return e.success = function (t, e, i) {
        n && (t.off("error", this._forwardPristineError, this), s.add(t, i)), r && r.call(i.context, t, e, i);
    ...
    _forwardPristineError: function _forwardPristineError(t, e, i) {
    ...
    delegateEvents: function delegateEvents(t) {
      if (t = t || b.result(this, "events")) for (var e in this.undelegateEvents(), t) {
        var i = t[e];
    ...
    var i,
      ...
      dataType: "json"
        ...
        o = (n.url || (r.url = b.result(e, "url") || R()), null != n.data || !e || "create" !== t && "update" !== t && "patch" !== t || (r.contentType = "application/json", r.data = JSON.stringify(n.attrs || e.toJSON(n))), n.emulateJSON && (r.contentType = "application/x-www-form-urlencoded", r.data = r.data ? {
      model: r.data
    ...
    t = t || {}, this.preinitialize.apply(this, arguments), t.routes && (this.routes = t.routes), this._bindRoutes(), this.initialize.apply(this, arguments);
      ...
      O = /\*\w+/g,
      U = /[\-{}\[\]+?.,\\\^$|#\s]/g,
      M = (b.extend($.prototype, e, {
    preinitialize: function preinitialize() {},
    initialize: function initialize() {},
    route: function route(e, i, n) {
    ...
    this.handlers = [], this.checkUrl = this.checkUrl.bind(this), "undefined" != typeof window && (this.location = window.location, this.history = window.history);
      ...
      q = /^\/+|\/+$/g,
      F = /#.*$/,
      R = (M.started = !1, b.extend(M.prototype, e, {
    interval: 50,
    ...
    start: function start(t) {
      ...
      if (M.started = !0, this.options = b.extend({
        root: "/"
    ...
    navigate: function navigate(t, e) {
      ...
      if (this.fragment !== n) {
        if (this.fragment = n, this._usePushState) this.history[e.replace ? "replaceState" : "pushState"]({}, document.title, i);else {
  ...
  }), h.history = new M(), v.extend = m.extend = $.extend = y.extend = M.extend = function (t, e) {
    var i = this,
