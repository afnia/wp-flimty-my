...
!function () {
      ...
      r = [], void 0 === (i = "function" == typeof (o = function o() {
        ...
        function D() {
          var n,
              ...
              i,
              u = d > 9 ? 9 : 1;
          if (p = Date.now(), s = !1, o = null, l > 2 || p - t - 50 < e) for (r = 0, i = c.length; r < i && w.timeRemaining() > u; r++) {
            n = c.shift(), v++, n && n(w);
          }
          c.length ? C() : l = 0;
        }
  ...
  !function () {
    ...
    n(3159);
    var e = "undefined" == typeof window ? function (e) {
      setTimeout(function () {
        return e(Date.now());
      }, 0);
      ...
      var o = function o(r) {
        ...
        try {
          for (var _iterator = t[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (t["delete"](_e), _n(), "number" == typeof r || r.timeRemaining() <= 0) break;
          }
        } catch (err) {
