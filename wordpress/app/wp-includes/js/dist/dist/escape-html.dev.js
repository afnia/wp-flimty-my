...
(function () {
  ...
  function _escapeAmpersand(value) {
  ...
  function _escapeQuotationMark(value) {
    return value.replace(/"/g, '&quot;');
  }
  /**
  ...
  function _escapeLessThan(value) {
    return value.replace(/</g, '&lt;');
  }
  /**
  ...
  function _escapeAttribute(value) {
    return __unstableEscapeGreaterThan(_escapeQuotationMark(_escapeAmpersand(value)));
  }
  /**
  ...
  function _escapeHTML(value) {
    return _escapeLessThan(_escapeAmpersand(value));
  }
  /**
  ...
  function _escapeEditableHTML(value) {
    return _escapeLessThan(value.replace(/&/g, '&amp;'));
  }
  /**
  ...
  function _isValidAttributeName(name) {
