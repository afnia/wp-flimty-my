...
(function () {
  ...
  var history_history = createBrowserHistory();
  var originalHistoryPush = history_history.push;
  var originalHistoryReplace = history_history.replace;

  function push(params, state) {
    var currentArgs = (0, external_wp_url_namespaceObject.getQueryArgs)(window.location.href);
    var currentUrlWithoutArgs = (0, external_wp_url_namespaceObject.removeQueryArgs).apply(void 0, [window.location.href].concat(_toConsumableArray(Object.keys(currentArgs))));
    var newUrl = (0, external_wp_url_namespaceObject.addQueryArgs)(currentUrlWithoutArgs, params);
  ...
  var build_module_history = history_history;
  ...
  var RoutesContext = (0, external_wp_element_namespaceObject.createContext)();
  var HistoryContext = (0, external_wp_element_namespaceObject.createContext)();
  ...
  function RouterProvider(_ref2) {
    ...
    var _ref3 = (0, external_wp_element_namespaceObject.useState)(function () {
      return getLocationWithParams(build_module_history.location);
    }),
    ...
    (0, external_wp_element_namespaceObject.useEffect)(function () {
      return build_module_history.listen(function (_ref5) {
        var updatedLocation = _ref5.location;
  ...
  var _ref6 = (0, external_wp_privateApis_namespaceObject.__dangerousOptInToUnstableAPIsOnlyForCoreModules)('I know using unstable features means my theme or plugin will inevitably break in the next version of WordPress.', '@wordpress/router'),
      lock = _ref6.lock,
      unlock = _ref6.unlock;
