...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e(t.WHATWGFetch = {});
}(void 0, function (t) {
  "use strict";

  var e,
      r,
      o = "undefined" != typeof globalThis && globalThis || "undefined" != typeof self && self || "undefined" != typeof global && global || {},
  ...
  function m() {
    return this.bodyUsed = !1, this._initBody = function (t) {
      ...
      var t,
          ...
          o = y(this);
      if (o) return o;
      if (this._bodyBlob) return o = this._bodyBlob, e = p(t = new FileReader()), r = (r = /charset=([A-Za-z0-9_-]+)/.exec(o.type)) ? r[1] : "utf-8", t.readAsText(o, r), e;
  ...
  h && (e = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], r = ArrayBuffer.isView || function (t) {
  ...
  }, i && (c.prototype[Symbol.iterator] = c.prototype.entries);
  ...
  function E(t, e) {
    ...
    if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new c(e.headers)), this.method = (r = (t = e.method || this.method || "GET").toUpperCase(), -1 < w.indexOf(r) ? r : t), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal || function () {
    ...
    this._initBody(n), "GET" !== this.method && "HEAD" !== this.method || "no-store" !== e.cache && "no-cache" !== e.cache || ((r = /([?&])_=[^&]*/).test(this.url) ? this.url = this.url.replace(r, "$1_=" + new Date().getTime()) : this.url += (/\?/.test(this.url) ? "&" : "?") + "_=" + new Date().getTime());
  }
  ...
  function A(t) {
    ...
    return t.trim().split("&").forEach(function (t) {
      var r;
      t && (r = (t = t.split("=")).shift().replace(/\+/g, " "), t = t.join("=").replace(/\+/g, " "), e.append(decodeURIComponent(r), decodeURIComponent(t)));
    }), e;
  }
  ...
  function g(t, e) {
    ...
    this.ok = 200 <= this.status && this.status < 300, this.statusText = void 0 === e.statusText ? "" : "" + e.statusText, this.headers = new c(e.headers), this.url = e.url || "", this._initBody(t);
  }
    ...
    return new Promise(function (n, i) {
      ...
      y.onload = function () {
        var t,
          ...
          headers: (t = y.getAllResponseHeaders() || "", e = new c(), t.replace(/\r?\n[\t ]+/g, " ").split("\r").map(function (t) {
            ...
            o = (r.url = "responseURL" in y ? y.responseURL : r.headers.get("X-Request-URL"), "response" in y ? y.response : y.responseText);
        setTimeout(function () {
          n(new g(o, r));
        }, 0);
      }, y.onerror = function () {
      ...
      }, y.open(a.method, function (t) {
        try {
          return "" === t && o.location.href ? o.location.href : t;
        } catch (e) {
          return t;
        }
      }(a.url), !0), "include" === a.credentials ? y.withCredentials = !0 : "omit" === a.credentials && (y.withCredentials = !1), "responseType" in y && (s ? y.responseType = "blob" : h && (y.responseType = "arraybuffer")), r && "object" == _typeof(r.headers) && !(r.headers instanceof c || o.Headers && r.headers instanceof o.Headers) ? (d = [], Object.getOwnPropertyNames(r.headers).forEach(function (t) {
        d.push(u(t)), y.setRequestHeader(t, f(r.headers[t]));
      }), a.headers.forEach(function (t, e) {
        -1 === d.indexOf(e) && y.setRequestHeader(e, t);
      })) : a.headers.forEach(function (t, e) {
        y.setRequestHeader(e, t);
      }), a.signal && (a.signal.addEventListener("abort", p), y.onreadystatechange = function () {
        4 === y.readyState && a.signal.removeEventListener("abort", p);
      }), y.send(void 0 === a._bodyInit ? null : a._bodyInit);
    });
  }

  _.polyfill = !0, o.fetch || (o.fetch = _, o.Headers = c, o.Request = E, o.Response = g), t.Headers = c, t.Request = E, t.Response = g, t.fetch = _, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});