    ...
    if ("objectFit" in document.documentElement.style == 0 || i) {
      var n = function n(t, e, i) {
        ...
        return function (t) {
          ...
          l = function l(t) {
        if (void 0 === t || t instanceof Event) t = document.querySelectorAll("[data-object-fit]");else if (t && t.nodeName) t = [t];else if ("object" != _typeof(t) || !t.length || !t[0].nodeName) return !1;
        ...
        for (var e = 0; e < t.length; e++) {
          if (t[e].nodeName) {
            ...
            } else "video" === n ? 0 < t[e].readyState ? o(t[e]) : t[e].addEventListener("loadedmetadata", function () {
              o(this);
            }) : o(t[e]);
          }
        }
