  ...
  o.widget("wp.pointer", {
    options: {
      ...
      buttons: function buttons(t, i) {
        return o('<a class="close" href="#"></a>').text(wp.i18n.__("Dismiss")).on("click.pointer", function (t) {
    ...
    _update: function _update(t, i) {
      var e = this.options;
      i && (this.pointer.stop(), this.content.html(i), (i = e.buttons.call(this.element[0], t, this._handoff())) && i.wrap('<div class="wp-pointer-buttons" />').parent().appendTo(this.content), this.reposition());
    },
