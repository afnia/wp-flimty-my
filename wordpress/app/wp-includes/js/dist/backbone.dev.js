...
(function (factory) {
  ...
  Backbone.VERSION = '1.5.0'; // For Backbone's purposes, jQuery, Zepto, Ender, or My Library (kidding) owns
  // the `$` variable.
  ...
  var Model = Backbone.Model = function (attributes, options) {
    ...
    var defaults = _.result(this, 'defaults'); // Just _.defaults would work fine, but the additional _.extends
  ...
  _.extend(Collection.prototype, Events, {
    ...
    modelId: function modelId(attrs, idAttribute) {
    ...
    _forwardPristineError: function _forwardPristineError(model, collection, options) {
  ...
  _.extend(History.prototype, Events, {
    ...
    navigate: function navigate(fragment, options) {
      ...
      fragment = this.getFragment(fragment || ''); // Strip trailing slash on the root unless _trailingSlash is true
