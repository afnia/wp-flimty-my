...
window.wpAjax = jQuery.extend({
  unserialize: function unserialize(s) {
    var r = {},
        q,
        pp,
        i,
  ...
  parseAjaxResponse: function parseAjaxResponse(x, r, e) {
    ...
    if (x && _typeof(x) === 'object' && x.getElementsByTagName('wp_ajax')) {
      parsed.responses = [];
      parsed.errors = false;
  ...
  invalidateForm: function invalidateForm(selector) {
