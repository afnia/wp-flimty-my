...
(function () {
  ...
  var __webpack_modules__ = {
    ...
    function (_2) {
      ...
      /** @lends wp.media.model.PostMedia.prototype */
      {
        ...
        setSource: function setSource(attachment) {
        ...
        changeAttachment: function changeAttachment(attachment) {
    ...
    function _(module) {
      ...
      /** @lends wp.media.view.MediaFrame.MediaDetails.prototype */
      {
        ...
        renderMenu: function renderMenu(view) {
        ...
        setPrimaryButton: function setPrimaryButton(text, handler) {
            ...
            items: {
              button: {
                ...
                click: function click() {
                  ...
                  handler.call(this, controller, controller.state()); // Restore and reset the default state.
        ...
        renderAddTrackToolbar: function renderAddTrackToolbar() {
          this.setPrimaryButton(l10n.videoAddTrackTitle, function (controller, state) {
            ...
            if (-1 === content.indexOf(attachment.get('url'))) {
              content += ['<track srclang="en" label="English" kind="subtitles" src="', attachment.get('url'), '" />'].join('');
    ...
    function (_4) {
      ...
      /** @lends wp.media.view.MediaDetails */
      {
         ...
         * @return {HTMLElement}
         */
        prepareSrc: function prepareSrc(elem) {
  ...
  !function () {
    ...
    wp.media.mixin = {
       ...
       * @return {void}
       */
      removePlayer: function removePlayer(t) {
    ...
    wp.media.audio = {
       ...
       */
      shortcode: function shortcode(model) {
        var content;
