...
!function () {
  var i = {
    7727: function (_2) {
      ...
      var n = Backbone.$,
        ...
        saveCompat: function saveCompat(t, s) {
          var r = this;
    ...
    6940: function (_3) {
      ...
      var n = Backbone.Collection.extend({
        ...
        validator: function validator(e) {
          return !(!this.validateDestroyed && e.destroyed) && _.all(this.filters, function (t) {
        ...
        validateAll: function validateAll(t, e) {
        ...
        observe: function observe(t) {
          return this.observers = this.observers || [], this.observers.push(t), t.on("add change remove", this._validateHandler, this), t.on("add", this._addToTotalAttachments, this), t.on("remove", this._removeFromTotalAttachments, this), t.on("reset", this._validateAllHandler, this), this.validateAll(t), this;
        },
        ...
        _removeFromTotalAttachments: function _removeFromTotalAttachments() {
          this.mirroring && (this.mirroring.totalAttachments = this.mirroring.totalAttachments - 1);
        },
        _addToTotalAttachments: function _addToTotalAttachments() {
          this.mirroring && (this.mirroring.totalAttachments = this.mirroring.totalAttachments + 1);
        },
        _validateHandler: function _validateHandler(t, e, i) {
          return i = e === this.mirroring ? i : {
            silent: i && i.silent
          }, this.validate(t, i);
        },
        _validateAllHandler: function _validateAllHandler(t, e) {
        ...
        more: function more(t) {
          ...
          }), e) : e.resolveWith(this)).promise();
        },
        hasMore: function hasMore() {
          return !!this.mirroring && this.mirroring.hasMore();
        },
        totalAttachments: 0,
        getTotalAttachments: function getTotalAttachments() {
          return this.mirroring ? this.mirroring.totalAttachments : 0;
        },
        parse: function parse(t, i) {
          return _.isArray(t) || (t = [t]), _.map(t, function (t) {
            var e;
            return t instanceof Backbone.Model ? (e = t.get("id"), t = t.attributes) : e = t.id, t = (e = wp.media.model.Attachment.get(e)).parse(t, i), _.isEqual(e.attributes, t) || e.set(t), e;
          });
        },
        _requery: function _requery() {
          var t;
          this.props.get("query") && (t = this.props.toJSON(), this.mirror(wp.media.model.Query.get(t)));
        },
        saveMenuOrder: function saveMenuOrder() {
        ...
        comparator: function comparator(t, e, i) {
        ...
        filters: {
          ...
          type: function type(t) {
            var e,
                ...
                t = t.toJSON();
            return !(i && (!_.isArray(i) || i.length)) || (e = t.mime || t.file && t.file.type || "", _.isArray(i) ? _.find(i, function (t) {
              return -1 !== e.indexOf(t);
            }) : -1 !== e.indexOf(i));
          },
          uploadedTo: function uploadedTo(t) {
    ...
    5927: function _(t) {
      var e = Backbone.Model.extend({
        ...
        bindAttachmentListeners: function bindAttachmentListeners() {
        ...
        changeAttachment: function changeAttachment(t, e) {
        ...
        setLinkTypeFromUrl: function setLinkTypeFromUrl() {
          var t,
              e = this.get("linkUrl");
        ...
        updateLinkUrl: function updateLinkUrl() {
          var t;

          switch (this.get("link")) {
            case "file":
              t = (this.attachment || this).get("url"), this.set("linkUrl", t);
              break;
        ...
        updateSize: function updateSize() {
          var t;
          this.attachment && ("custom" === this.get("size") ? (this.set("width", this.get("customWidth")), this.set("height", this.get("customHeight")), this.set("url", this.get("originalUrl"))) : (t = this.attachment.get("sizes")[this.get("size")]) && (this.set("url", t.url), this.set("width", t.width), this.set("height", t.height)));
        },
      ...
      var a,
        ...
        more: function more(t) {
          ...
          return this._more && "pending" === this._more.state() ? this._more : this.hasMore() ? ((t = t || {}).remove = !1, this._more = this.fetch(t).done(function (t) {
            (_.isEmpty(t) || -1 === e.args.posts_per_page || t.length < e.args.posts_per_page) && (e._hasMore = !1);
        ...
        get: (a = [], function (e, t) {
          var i,
              ...
              r = o.orderby,
              n = o.defaultProps;
          return delete e.query, _.defaults(e, n), e.order = e.order.toUpperCase(), "DESC" !== e.order && "ASC" !== e.order && (e.order = n.order.toUpperCase()), _.contains(r.allowed, e.orderby) || (e.orderby = n.orderby), _.each(["include", "exclude"], function (t) {
            e[t] && !_.isArray(e[t]) && (e[t] = [e[t]]);
          }), _.each(e, function (t, e) {
            _.isNull(t) || (s[o.propmap[e] || e] = t);
          }), _.defaults(s, o.defaultArgs), s.orderby = r.valuemap[e.orderby] || e.orderby, a = [], i || (i = new o([], _.extend(t || {}, {
            props: e,
            args: s
          })), a.push(i)), i;
        })
    ...
    6584: function (_5) {
      ...
      var i = wp.media.model.Attachments,
          e = i.extend({
        initialize: function initialize(t, e) {
          i.prototype.initialize.apply(this, arguments), this.multiple = e && e.multiple, this.on("add remove reset", _.bind(this.single, this, !1));
        },
        add: function add(t, e) {
          return this.multiple || this.remove(this.models), i.prototype.add.call(this, t, e);
        },
        single: function single(t) {
          var e = this._single;
  ...
  window.wp = window.wp || {}, a = wp.media = function (t) {
    ...
    controller: {},
    frames: {}
  }), t = a.model.l10n = window._wpMediaModelsL10n || {}, a.model.settings = t.settings || {}, delete t.settings, e = a.model.Attachment = r(7727), n = a.model.Attachments = r(6940), a.model.Query = r(4009), a.model.PostImage = r(5927), a.model.Selection = r(6584), a.compare = function (t, e, i, s) {
    ...
    fit: function fit(t) {
      var e,
          ...
          r = t.maxWidth,
          t = t.maxHeight;
      return _.isUndefined(r) || _.isUndefined(t) ? _.isUndefined(t) ? e = "width" : _.isUndefined(r) && t < s && (e = "height") : e = r / t < i / s ? "width" : "height", "width" === e && r < i ? {
        width: r,
        height: Math.round(r * s / i)
      } : "height" === e && t < s ? {
        width: Math.round(t * i / s),
        height: t
      } : {
        width: i,
        height: s
    ...
    truncate: function truncate(t, e, i) {
      return i = i || "&hellip;", t.length <= (e = e || 30) ? t : t.substr(0, e / 2) + i + t.substr(-1 * e / 2);
    }
  }), a.attachment = function (t) {
    return e.get(t);
  }, n.all = new n(), a.query = function (t) {
    return new n(null, {
