...
"object" != (typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) && (JSON = {}), !function () {
  ...
  function str(t, e) {
    ...
    switch (i && "object" == _typeof(i) && "function" == typeof i.toJSON && (i = i.toJSON(t)), _typeof(i = "function" == typeof rep ? rep.call(e, t, i) : i)) {
      case "string":
        return quote(i);
      ...
      case "object":
        ...
        if (gap += indent, f = [], "[object Array]" === Object.prototype.toString.apply(i)) {
          ...
          if (rep && "object" == _typeof(rep)) for (u = rep.length, r = 0; r < u; r += 1) {
  ...
  "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function () {
    ...
    if (!(rep = e) || "function" == typeof e || "object" == _typeof(e) && "number" == typeof e.length) return str("", {
      "": t
    });
