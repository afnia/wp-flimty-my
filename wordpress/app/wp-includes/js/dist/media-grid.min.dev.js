  ...
  var i = {
    ...
    7433: function (_2) {
      ...
      var e = wp.media.view.Attachment.Details,
        ...
        initialize: function initialize() {
          this.controller.on("content:activate:edit-details", _.bind(this.editAttachment, this)), e.prototype.initialize.apply(this, arguments);
        },
    ...
    5562: function _(t) {
      var e = wp.media.view.Button,
          ...
          o = i.extend({
        initialize: function initialize() {
          i.prototype.initialize.apply(this, arguments), this.controller.on("select:activate", this.selectActivate, this), this.controller.on("select:deactivate", this.selectDeactivate, this);
        },
        ...
        render: function render() {
          return e.prototype.render.apply(this, arguments), this.selectActivate(), this;
        }
      });
      t.exports = o;
    },
    471: function _(t) {
      var e = wp.media.view.Button,
          ...
          o = e.extend({
        initialize: function initialize() {
          e.prototype.initialize.apply(this, arguments), this.options.filters && this.options.filters.model.on("change", this.filterChange, this), this.controller.on("selection:toggle", this.toggleDisabled, this), this.controller.on("select:activate", this.toggleDisabled, this);
        },
        filterChange: function filterChange(t) {
          "trash" === t.get("status") ? this.model.set("text", i.restoreSelected) : wp.media.view.settings.mediaTrash ? this.model.set("text", i.trashSelected) : this.model.set("text", i.deletePermanently);
        },
        toggleDisabled: function toggleDisabled() {
          this.model.set("disabled", !this.controller.state().get("selection").length);
        },
        render: function render() {
          return e.prototype.render.apply(this, arguments), this.controller.isModeActive("select") ? this.$el.addClass("delete-selected-button") : this.$el.addClass("delete-selected-button hidden"), this.toggleDisabled(), this;
        }
      });
      t.exports = o;
    },
      ...
      var e = wp.media.view.Button,
        ...
        initialize: function initialize() {
          _.defaults(this.options, {
            size: ""
          }), e.prototype.initialize.apply(this, arguments), this.controller.on("select:activate select:deactivate", this.toggleBulkEditHandler, this), this.controller.on("selection:action:done", this.back, this);
        },
        back: function back() {
          this.controller.deactivateMode("select").activateMode("edit");
        },
        click: function click() {
          e.prototype.click.apply(this, arguments), this.controller.isModeActive("select") ? this.back() : this.controller.deactivateMode("edit").activateMode("select");
        },
        render: function render() {
          return e.prototype.render.apply(this, arguments), this.$el.addClass("select-mode-toggle-button"), this;
        },
    ...
    9157: function (_4) {
      ...
      var e = wp.media.View,
        ...
        initialize: function initialize(t) {
          this.editor = window.imageEdit, this.frame = t.frame, this.controller = t.controller, e.prototype.initialize.apply(this, arguments);
        },
        back: function back() {
      ...
      var e = wp.media.view.Frame,
        ...
        createModal: function createModal() {
          this.options.modal && (this.modal = new wp.media.view.Modal({
            ...
            o("body").on("keydown.media-modal", _.bind(this.keyEvent, this));
          }, this)), this.modal.on("close", _.bind(function () {
            o("body").off("keydown.media-modal"), o('li.attachment[data-id="' + this.model.get("id") + '"]').trigger("focus"), this.resetRoute();
        ...
        keyEvent: function keyEvent(t) {
          ("INPUT" !== t.target.nodeName && "TEXTAREA" !== t.target.nodeName || t.target.disabled) && (39 === t.keyCode && this.nextMediaItem(), 37 === t.keyCode) && this.previousMediaItem();
        },
        resetRoute: function resetRoute() {
          var t = this.controller.browserView.toolbar.get("search").$el.val();
          this.gridRouter.navigate(this.gridRouter.baseUrl("" !== t ? "?search=" + t : ""), {
            replace: !0
          });
        }
      });
    ...
    4817: function (_6) {
      ...
      var e = wp.media.view.MediaFrame,
        ...
        bindSearchHandler: function bindSearchHandler() {
          var t = this.$("#media-search-input"),
            ...
            var t = s(t.currentTarget).val(),
                e = "";
            t && this.gridRouter.navigate(this.gridRouter.baseUrl(e += "?search=" + t), {
              replace: !0
            });
          }, 1e3);
        ...
        createStates: function createStates() {
          var t = this.options;
          this.options.states || this.states.add([new i({
