...
window.addComment = function (v) {
  ...
  function d(e) {
    if (r && (I = g(b.cancelReplyId), C = g(b.commentFormId), I)) {
      var _t = function _t(e) {
        if ((e.metaKey || e.ctrlKey) && 13 === e.keyCode) return C.removeEventListener("keydown", _t), e.preventDefault(), C.submit.click(), !1;
      };

      I.addEventListener("touchstart", l), I.addEventListener("click", l);
      C && C.addEventListener("keydown", _t);
  ...
  return r && "loading" !== E.readyState ? t() : r && v.addEventListener("DOMContentLoaded", t, !1), {
    init: d,
    moveForm: function moveForm(e, t, n, d, o) {
      var i,
          r,
          l,
          a,
