...
window.addComment = function (window) {
  ...
  var supportsDataset = !!document.documentElement.dataset; // For holding the cancel element.
  ...
  function replyLinks(context) {
    ...
    var allReplyLinks; // childNodes is a handy check to ensure the context is a HTMLElement.
  ...
  function moveForm(addBelowId, commentId, respondId, postId, replyTo) {
    ...
    try {
      for (var i = 0; i < commentFormElement.elements.length; i++) {
        ...
        cssHidden = false; // Get elements computed style.
