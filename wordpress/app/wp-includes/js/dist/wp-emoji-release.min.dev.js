...
var twemoji = function () {
  ...
  var m = {
    ...
    className: "emoji",
    convert: {
      fromCodePoint: function fromCodePoint(d) {
    ...
    parse: function parse(d, u) {
      ...
      return m.doNotParse = u.doNotParse, ("string" == typeof d ? function (d, a) {
        ...
        var f,
          ...
          for (; a--;) {
            c = b[a], 3 === (e = c.nodeType) ? f.push(c) : 1 !== e || "ownerSVGElement" in c || g.test(c.nodeName.toLowerCase()) || m.doNotParse && m.doNotParse(c) || d(c, f);
          }
        ...
        for (; p--;) {
          for (e = !1, b = document.createDocumentFragment(), a = l[p], t = a.nodeValue, r = 0; o = h.exec(t);) {
            if ((s = o.index) !== r && b.appendChild(x(t.slice(r, s), !0)), o = o[0], i = N(o), r = s + o.length, s = u.callback(i, u), i && s) {
              for (c in (n = new Image()).onerror = u.onerror, n.setAttribute("draggable", "false"), f = u.attributes(o, i)) {
  ...
  function o(d, u) {
    for (var f = [], c = 0, e = 0, b = 0; b < d.length;) {
      c = d.charCodeAt(b++), e ? (f.push((65536 + (e - 55296 << 10) + (c - 56320)).toString(16)), e = 0) : 55296 <= c && c <= 56319 ? e = c : f.push(c.toString(16));
    }
  ...
  c.wp = c.wp || {}, c.wp.emoji = new function () {
          ...
          for (var e, t, n, a, r = u.length; r--;) {
            ...
            for (; n--;) {
              if (3 === (a = e[n]).nodeType) {
                ...
                if (o) for (; a.nextSibling && 3 === a.nextSibling.nodeType;) {
    ...
    function f(u, e) {
      ...
      return !l.supports.everything && n && u && ("string" == typeof u || u.childNodes && u.childNodes.length) ? (e = e || {}, t = {
        ...
        callback: function callback(u, e) {
          switch (u) {
            case "a9":
            case "ae":
            case "2122":
