...
!function ($) {
  $.Jcrop = function (obj, opt) {
    ...
    function setOptions(opt) {
      "object" != _typeof(opt) && (opt = {}), options = $.extend(options, opt), $.each(["onChange", "onSelect", "onRelease", "onDblClick"], function (i, e) {
    ...
    "object" != _typeof(obj) && (obj = $(obj)[0]), "object" != _typeof(opt) && (opt = {}), setOptions(opt);
    var img_css = {
      border: "none",
      visibility: "visible",
      margin: 0,
    ...
    var Touch = function () {
      ...
      function trackUp(e) {
        return e.preventDefault(), e.stopPropagation(), btndown && (btndown = !1, onDone(mouseAbs(e)), Selection.isAwake() && options.onSelect.call(api, unscale(Coords.getFixed())), toBack(), onMove = function onMove() {}, onDone = function onDone() {}), !1;
      }
