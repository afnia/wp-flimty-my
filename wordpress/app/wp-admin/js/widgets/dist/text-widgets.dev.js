...
wp.textWidgets = function ($) {
  ...
  /** @lends wp.textWidgets.TextWidgetControl.prototype */
  {
    ...
    initializeEditor: function initializeEditor() {
      ...
      triggerChangeIfDirty = function triggerChangeIfDirty() {
      ...
      function buildEditor() {
        var editor, onInit, showPointerElement; // Abort building if the textarea is gone, likely due to the widget having been deleted entirely.
        ...
        showPointerElement = function showPointerElement(pointerElement) {
          pointerElement.show();
