...
wp.customHtmlWidgets = function ($) {
  ...
  /** @lends wp.customHtmlWidgets.CustomHtmlWidgetControl.prototype */
  {
     ...
     * @return {void}
     */
    updateErrorNotice: function updateErrorNotice(errorAnnotations) {
      var control = this,
          errorNotice,
          message = '',
          customizeSetting;
    ...
    initializeEditor: function initializeEditor() {
      ...
      control.editor = wp.codeEditor.initialize(control.fields.content, settings); // Improve the editor accessibility.
