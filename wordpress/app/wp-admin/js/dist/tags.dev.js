...
jQuery(function ($) {
  ...
  $('#submit').on('click', function () {
    ...
    $.post(ajaxurl, $('#addtag').serialize(), function (r) {
      ...
      parent = form.find('select#parent').val(); // If the parent exists on this page, insert it below. Else insert it at the top of the list.
      ...
      if (form.find('select#parent')) {
        ...
        term = res.responses[1].supplemental; // Create an indent for the Parent field.
