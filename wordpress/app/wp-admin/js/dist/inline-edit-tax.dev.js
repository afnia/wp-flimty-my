  ...
  window.inlineEditTax = {
    ...
    edit: function edit(id) {
      var editRow,
          ...
          val,
          t = this;
      t.revert(); // Makes sure we can pass an HTMLElement as the ID.
    ...
    save: function save(id) {
      var params,
          fields,
          tax = $('input[name="taxonomy"]').val() || ''; // Makes sure we can pass an HTMLElement as the ID.
      ...
      params = fields + '&' + $.param(params); // Do the Ajax request to save the data to the server.
    ...
    revert: function revert() {
      ...
      if (id) {
        ...
        id = id.substr(id.lastIndexOf('-') + 1); // Show the taxonomy row and move focus back to the Quick Edit button.
