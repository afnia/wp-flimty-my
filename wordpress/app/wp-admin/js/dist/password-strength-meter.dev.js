...
(function ($) {
  ...
  wp.passwordStrength = {
     ...
     */
    meter: function meter(password1, disallowedList, password2) {
     ...
     */
    userInputBlacklist: function userInputBlacklist() {
     ...
     * @return {string[]} The array of words to be disallowed.
     */
    userInputDisallowedList: function userInputDisallowedList() {
      var i,
          ...
          rawValues = [],
          disallowedList = [],
          userInputFields = ['user_login', 'first_name', 'last_name', 'nickname', 'display_name', 'email', 'url', 'description', 'weblog_title', 'admin_email']; // Collect all the strings we want to disallow.
